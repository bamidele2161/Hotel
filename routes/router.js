...
const testCont = require("../controller/hotel/test");
...
route.get("/viewHotel/:id", userMiddleAuth, hotelController.getHotel);
...
route.get("/allBookings", reservationController.getAllBookings);

route.post("/test", testCont.testCreate);
